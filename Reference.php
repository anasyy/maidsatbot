...
$token = "EAABgZCEcIOZCkBADtNf3QWWVtZCxmvZBSaQJ0dttRznZAtksyR42u3ZBmRQncrMHRHKUptURwtMKSZB6SejZB2ZCMwEDvlpT31Iy9wBBFc1oIS52bBAAF1sv7sZAI3bPlFVEevmrytCIsFJCqTSFGkAFZAHbWWH5hnNkKmWP9aldrJWyQZDZD";
        ...
        foreach ($data['entry'][0]['messaging'] as $message) {
            ...
            switch ($command) {
                ...
                case 'profile':
                    ...
                    $buttonsElement = [new MessageButton(MessageButton::TYPE_POSTBACK, 'First button'),
                    ...
                    $bot->send(new StructuredMessage($message['sender']['id'],
                        ...
                        [
                            'elements' => [
                                new MessageElement($user->getFirstName()." ".$user->getLastName(), " ", $user->getPicture(), $buttonsElement)
                            ]
                        ]
                    ));
